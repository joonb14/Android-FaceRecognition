...
package com.google.mlkit.vision.joonb14.java.facedetector;
...
import com.google.mlkit.vision.joonb14.GraphicOverlay.Graphic;
import com.google.mlkit.vision.joonb14.java.CosineSim;
...
public class FaceGraphic extends Graphic {
  ...
  private CosineSim[] top5_list;

  FaceGraphic(GraphicOverlay overlay, Face face, CosineSim[] top5_list) {
    super(overlay);

    this.face = face;
    this.top5_list = top5_list;
